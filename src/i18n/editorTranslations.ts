...
export const editorTranslations: Record<string, Record<string, string>> = {
  ...
  "en": {
    ...
    "Balanced (Rekomendasi)": "Balanced (Rekomendasi)",
    "Kualitas bagus, ukuran optimal": "Kualitas bagus, ukuran optimal",
    "High (Terbaik)": "High (Terbaik)",
    "Kualitas tinggi, ukuran lumayan besar": "Kualitas tinggi, ukuran lumayan besar",
    ...
    "Edit & Sign": "Edit & Sign",
    "Interactive Split": "Interactive Split",
    "Ketik rentang halaman yang ingin Anda potong/ekstrak.": "Ketik rentang halaman yang ingin Anda potong/ekstrak.",
    "Rentang Halaman (Contoh: 1-3, 5, 8)": "Rentang Halaman (Contoh: 1-3, 5, 8)",
    "Halaman yang masuk dalam rentang ini akan ditandai dengan label \"EXTRACT\" berwarna hijau pada Live Preview di sebelah kiri.": "Halaman yang masuk dalam rentang ini akan ditandai dengan label \"EXTRACT\" berwarna hijau pada Live Preview di sebelah kiri.",
    "Potong Sekarang": "Potong Sekarang",
    "Gabungkan Sekarang": "Gabungkan Sekarang",
    "Gabungkan Skearang": "Gabungkan Skearang",
    "Pilih Dokumen Pratinjau:": "Pilih Dokumen Pratinjau:",
    "Interactive Merge": "Interactive Merge",
    "Atur urutan file PDF di bawah dengan menggeser (Drag & Drop) kartu dokumen.": "Atur urutan file PDF di bawah dengan menggeser (Drag & Drop) kartu dokumen.",
    "Interactive Rotate": "Interactive Rotate",
    "Putar orientasi dokumen Anda. Perubahan akan terlihat langsung pada layar pratinjau.": "Putar orientasi dokumen Anda. Perubahan akan terlihat langsung pada layar pratinjau.",
    "Rotasi Cepat": "Rotasi Cepat",
    "Derajat Khusus": "Derajat Khusus",
    ...
    "Interactive Page Numbers": "Interactive Page Numbers",
    "Atur posisi penomoran halaman. Angka akan muncul secara *real-time* di kanvas.": "Atur posisi penomoran halaman. Angka akan muncul secara *real-time* di kanvas.",
    "Pilih Posisi Angka": "Pilih Posisi Angka",
    "Gaya Penomoran": "Gaya Penomoran",
    "Format Teks": "Format Teks",
    "Mulai di Halaman": "Mulai di Halaman",
    "Angka Awal": "Angka Awal",
    "Terapkan Penomoran": "Terapkan Penomoran",
    "Hapus Halaman": "Hapus Halaman",
    "Ketik rentang atau nomor halaman yang ingin Anda hapus secara permanen.": "Ketik rentang atau nomor halaman yang ingin Anda hapus secara permanen.",
    "Halaman yang Dihapus (Contoh: 1, 3-5)": "Halaman yang Dihapus (Contoh: 1, 3-5)",
    "Halaman yang masuk dalam rentang ini akan ditandai dengan label merah \"HAPUS\" di Live Preview.": "Halaman yang masuk dalam rentang ini akan ditandai dengan label merah \"HAPUS\" di Live Preview.",
    "Hapus Sekarang": "Hapus Sekarang",
    "Menganalisis Perbedaan...": "Menganalisis Perbedaan...",
    "Bandingkan PDF Sekarang": "Bandingkan PDF Sekarang",
    "Klik untuk Unggah PDF Pembanding": "Klik untuk Unggah PDF Pembanding",
    "Mengompres...": "Mengompres...",
