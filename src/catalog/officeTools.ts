...
export const officeTools: ToolDefinition[] = [
  ...
  */
  ...
  {
    id: 'pdf-to-word-without-losing-formatting',
    category: 'office',
    iconName: 'FileText',
    slugs: generateSlugsForId('pdf-to-word-without-losing-formatting', {
      en: 'pdf-to-word-without-losing-formatting',
      id: 'pdf-ke-word-tanpa-kehilangan-format',
      es: 'pdf-a-word-sin-perder-formato',
      fr: 'pdf-en-word-sans-perdre-le-formatage',
      de: 'pdf-in-word-umwandeln-ohne-dass-die-formatierung-verloren-geht',
      ja: 'pdf-word',
      pt: 'pdf-para-word-sem-perder-formata-o',
      ru: 'pdf-word',
      zh: 'pdf-word',
      ar: 'pdf-word',
      it: 'pdf-in-word-senza-perdere-la-formattazione',
      ko: 'pdf-to-word-without-losing-formatting',
      nl: 'pdf-naar-word-zonder-de-opmaak-te-verliezen',
      tr: 'bi-imlendirmeyi-kaybetmeden-pdf-yi-word-e-d-n-t-rme',
      pl: 'pdf-na-s-owo-bez-utraty-formatowania',
      vi: 'pdf-sang-word-m-kh-ng-m-t-nh-d-ng',
      th: 'pdf-word',
      sv: 'pdf-till-word-utan-att-f-rlora-formatering',
      cs: 'pdf-do-wordu-bez-ztr-ty-form-tov-n',
      da: 'pdf-til-word-uden-at-miste-formatering',
      el: 'pdf-word',
      fi: 'pdf-wordiksi-menett-m-tt-muotoilua',
      he: 'pdf-word',
      hu: 'pdf-b-l-word-be-a-form-z-s-elveszt-se-n-lk-l',
      no: 'pdf-til-word-uten-miste-formatering',
      ro: 'pdf-n-word-f-r-a-pierde-formatarea',
      sk: 'pdf-do-wordu-bez-straty-form-tovania',
      uk: 'pdf-word',
      ms: 'pdf-ke-perkataan-tanpa-kehilangan-pemformatan',
    }),
    seo: {
      en: {
      ...
      id: {
        title: 'Konversi PDF ke Word Online Gratis (.docx) Tanpa Merusak Format',
      ...
      es: {
        title: 'Convertir PDF a Word Gratis (.docx) Sin Perder Formato',
        h1: 'Convierte PDF en Archivos de Word DOCX Editables',
        description: 'Extrae texto exacto y párrafos de archivos PDF en documentos de Microsoft Word (.docx) directamente en tu navegador offline.',
